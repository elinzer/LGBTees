  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    ...
    await queryInterface.bulkInsert('Tees', [
      ...
      {
        name: 'Alphabet Mafia',
        url: 'https://www.awarewolfapparel.com/products/alphabhttps://www.atribecalledqueer.org/product-page/pride-was-a-riot-t-shirt',
        userId: 1,
        price: 19.99,
        brand: 'Awarewolf Apparel',
        brandUrl: 'https://www.atribecalledqueer.org/',
        imageUrl: 'https://cdn.shopify.com/s/files/1/1494/9378https://static.wixstatic.com/media/ccb29d_1ed41e1d3538433ead61d81c9eb4def2~mv2.jpg/v1/fill/w_1000,h_1000,al_c,q_85/ccb29d_1ed41e1d3538433ead61d81c9eb4def2~mv2.webp/products/mafi_gold_1728x.png',
      },
      {
        name: 'Alphabet Mafia',
